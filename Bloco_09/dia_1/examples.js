...
// // Código não funciona por causa do setTimeout na linha 34
// const assert = require('assert');
...
// // Código funciona por causa do setTimeout adicionado na linha 54
// const assert = require('assert');
...
const handleExpenses = myExpenses => {
  ...
  const totalExpenses = eachValue.reduce((acc, curr) => acc + curr, 0);
